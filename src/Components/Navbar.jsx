...
const Navbar = () => {
  return (
    <div className="mx-auto flex justify-between w-9/10">
      <div className="bg-gray-900 w-7/10 h-20 px-1 py-3 items-center justify-around rounded-full flex">
      ...
      <div className="bg-gray-900 h-20 w-20 flex items-center justify-center rounded-full">
